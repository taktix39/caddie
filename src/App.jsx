...
export default function App(){
  ...
  async function handleGoogleLogin(){
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: { redirectTo: 'https://caddie-eta.vercel.app' }
    });
    ...
    return(
      <div style={{...S.wrap,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",padding:"0 32px"}}>
        ...
        <div style={{width:"100%"}}>
          ...
          <div style={{fontSize:13,color:"#999",marginBottom:32,textAlign:"center"}}>Googleアカウントでかんたんにログイン</div>
          <button onClick={handleGoogleLogin} style={{width:"100%",padding:"13px 16px",borderRadius:10,border:"1px solid #dadce0",background:"#fff",display:"flex",alignItems:"center",justifyContent:"center",gap:12,fontSize:15,fontWeight:600,color:"#3c4043",cursor:"pointer",boxShadow:"0 1px 3px rgba(0,0,0,0.1)"}}>
